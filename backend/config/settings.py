...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                # The staff masthead: the counts on it, and which of its links this
                # person may open. Both are a no-op for anything that is not a
                # signed-in staff page; see cars/staff/context.py.
                "cars.staff.context.attention",
                "cars.staff.context.can",
            ],
        },
    },
]
